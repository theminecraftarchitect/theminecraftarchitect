export default {
  async fetch(request, env) {
    ...
    const redirects = {
      ...
      '/tutorial-worlds/tu19-nether': '/tutorial-worlds',
      '/tutorial-worlds/tu46-nether': '/tutorial-worlds',
      '/tutorial-worlds/tu31-nether': '/tutorial-worlds',
      '/tutorial-worlds/tu7-nether': '/tutorial-worlds',
      '/tutorial-worlds/tu5-nether': '/tutorial-worlds',
      '/tutorial-worlds/tu12-nether': '/tutorial-worlds',
      '/tutorial-worlds/tu9-nether': '/tutorial-worlds',
